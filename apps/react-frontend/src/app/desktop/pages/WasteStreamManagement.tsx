...
export const WasteStreamManagement = () => {
  ...
  const tabs: {
    ...
    {
      name: 'Afvalstroomnummers',
      component: () => (
        <AfvalstroomnummersTab key={`afvalstroomnummers-${selectedIndex}`} />
      ),
    },
    {
      name: 'LMA',
      component: () => <LMATab key={`lma-${selectedIndex}`} />,
      hasNotification: hasPendingApprovals,
    },
  ];
