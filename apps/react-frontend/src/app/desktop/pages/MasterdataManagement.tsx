...
export const MasterdataManagement = () => {
  ...
  const tabs: { name: string; component: () => ReactNode }[] = [
    {
      name: 'Vrachtwagens',
      component: () => <TrucksTab key={`truck-${selectedIndex}`} />,
    },
    {
      name: 'Containers',
      component: () => (
        <WasteContainersTab key={`wastecontainer-${selectedIndex}`} />
      ),
    },
    {
      name: 'Eural Codes',
      component: () => <EuralCodesTab key={`eural-${selectedIndex}`} />,
    },
    {
      name: 'Verwerkingsmethodes',
      component: () => (
    ...
    },
    {
      ...
      component: () => <MaterialPricesTab key={`materialprices-${selectedIndex}`} />,
    },
    {
