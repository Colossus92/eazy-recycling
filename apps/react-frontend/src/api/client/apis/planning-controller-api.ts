...
// @ts-ignore
import type { DriverPlanningItem } from '../models';
// @ts-ignore
import type { PlanningView } from '../models';
// @ts-ignore
import type { TransportReorderRequest } from '../models';
/**
...
export const PlanningControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getPlanningByDate(pickupDate: string, truckId?: string, driverId?: string, status?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlanningView>> {
            ...
            const operationBasePath = operationServerMap['PlanningControllerApi.getPlanningByDate']?.[index]?.url;
        ...
        async getPlanningByDriver(driverId: string, startDate: string, endDate: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: { [key: string]: Array<DriverPlanningItem>; }; }>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['PlanningControllerApi.getPlanningByDriver']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * 
        ...
        async reorderTransports(transportReorderRequest: TransportReorderRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PlanningView>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['PlanningControllerApi.reorderTransports']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    };
};
...
export const PlanningControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getPlanningByDate(pickupDate: string, truckId?: string, driverId?: string, status?: string, options?: any): AxiosPromise<PlanningView> {
         ...
         * @throws {RequiredError}
         */
        getPlanningByDriver(driverId: string, startDate: string, endDate: string, options?: any): AxiosPromise<{ [key: string]: { [key: string]: Array<DriverPlanningItem>; }; }> {
         ...
         * @throws {RequiredError}
         */
        reorderTransports(transportReorderRequest: TransportReorderRequest, options?: any): AxiosPromise<PlanningView> {
