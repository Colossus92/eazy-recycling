...
// @ts-ignore
// @ts-ignore
import type { WasteContainerRequest, WasteContainerView } from '../models';
...
export const WasteContainerControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createContainer(wasteContainerRequest: WasteContainerRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
