...
export const WeightTicketControllerApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async cancel(weightTicketId: number, cancelWeightTicketRequest: CancelWeightTicketRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['WeightTicketControllerApi.cancel']?.[localVarOperationServerIndex]?.url;
        ...
        async complete(weightTicketId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WeightTicketControllerApi.complete']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async copy(weightTicketId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CopyWeightTicketResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WeightTicketControllerApi.copy']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
        ...
        async split(weightTicketId: number, splitWeightTicketRequest: SplitWeightTicketRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SplitWeightTicketResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['WeightTicketControllerApi.split']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
...
export const WeightTicketControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        cancel(weightTicketId: number, cancelWeightTicketRequest: CancelWeightTicketRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        complete(weightTicketId: number, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        copy(weightTicketId: number, options?: RawAxiosRequestConfig): AxiosPromise<CopyWeightTicketResponse> {
         ...
         * @throws {RequiredError}
         */
        split(weightTicketId: number, splitWeightTicketRequest: SplitWeightTicketRequest, options?: RawAxiosRequestConfig): AxiosPromise<SplitWeightTicketResponse> {
