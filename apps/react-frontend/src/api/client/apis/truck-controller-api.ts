...
// @ts-ignore
// @ts-ignore
import type { TruckRequest, TruckResult, TruckView } from '../models';
...
export const TruckControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createTruck(truckRequest: TruckRequest, options?: RawAxiosRequestConfig): AxiosPromise<TruckResult> {
         ...
         * @throws {RequiredError}
         */
        getAllTrucks(options?: RawAxiosRequestConfig): AxiosPromise<Array<TruckView>> {
         ...
         * @throws {RequiredError}
         */
        getTruckByLicensePlate(licensePlate: string, options?: RawAxiosRequestConfig): AxiosPromise<TruckView> {
         ...
         * @throws {RequiredError}
         */
        updateTruck(licensePlate: string, truckRequest: TruckRequest, options?: RawAxiosRequestConfig): AxiosPromise<TruckResult> {
