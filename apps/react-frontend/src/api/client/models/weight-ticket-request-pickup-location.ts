 ...
 * @export
 */
export type WeightTicketRequestPickupLocation = DutchAddressRequest | NoPickupLocationRequest | PickupCompanyRequest | ProjectLocationRequest | ProximityDescriptionRequest;
